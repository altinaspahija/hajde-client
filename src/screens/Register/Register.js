...
export default function Register({ navigation }) {
  ...
  const [confirmPasswordError,setConfirmErrorMessage]=React.useState("")
  ...
  const sendSMS = async (value) => {
    try {
      ...
      navigation.navigate("CodeVerificationRegister", { value,prefix });
    } catch (err) {
      Alert.alert("Mesazhi", err.response.data.message, [
        { text: "Në rregull" },
      ]);
        ...
        {({
          ...
          <ScrollView>
            <View style={styles.container}>
              ...
              <Text style={global.inputTitle}>Konfirmo Fjalëkalimin</Text>
              <View style={global.inputContainer}>
                <TextInput
              ...
              <ErrorMessage errorValue={confirmPasswordError} />
       
              <View style={styles.buttonContainer}>
                <LargeButton
                  title="Regjistrohu"
                  onPress={values.password === values.confirmPassword ? handleSubmit : () => setConfirmErrorMessage("Konfirmimi i fjalëkalimit nuk është i sakt!")}
